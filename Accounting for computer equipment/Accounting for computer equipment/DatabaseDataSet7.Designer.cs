...
namespace Accounting_for_computer_equipment {
    ...
    public partial class DatabaseDataSet7 : global::System.Data.DataSet {
        ...
        public partial class GoodsDataTable : global::System.Data.TypedTableBase<GoodsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public GoodsRow AddGoodsRow(string Name, string Description, string Type, string Price, string Manufacturer, string Supplier) {
        ...
        public partial class GoodsRow : global::System.Data.DataRow {
            ...
            public string Supplier {
                get {
                    return ((string)(this[this.tableGoods.SupplierColumn]));
                }
                set {
...
namespace Accounting_for_computer_equipment.DatabaseDataSet7TableAdapters {
    ...
    public partial class GoodsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Goods] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Description] = @Original_Description) AND ([Type] = @Original_Type) AND ([Price] = @Original_Price) AND ([Manufacturer] = @Original_Manufacturer) AND ([Supplier] = @Original_Supplier))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Goods] ([Name], [Description], [Type], [Price], [Manufacturer], [Supplier]) VALUES (@Name, @Description, @Type, @Price, @Manufacturer, @Supplier);
SELECT Id, Name, Description, Type, Price, Manufacturer, Supplier FROM Goods WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Goods] SET [Name] = @Name, [Description] = @Description, [Type] = @Type, [Price] = @Price, [Manufacturer] = @Manufacturer, [Supplier] = @Supplier WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Description] = @Original_Description) AND ([Type] = @Original_Type) AND ([Price] = @Original_Price) AND ([Manufacturer] = @Original_Manufacturer) AND ([Supplier] = @Original_Supplier));
SELECT Id, Name, Description, Type, Price, Manufacturer, Supplier FROM Goods WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Description, Type, Price, Manufacturer, Supplier FROM dbo.Goods";
        ...
        public virtual int Fill(DatabaseDataSet7.GoodsDataTable dataTable) {
        ...
        public virtual DatabaseDataSet7.GoodsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet7.GoodsDataTable dataTable = new DatabaseDataSet7.GoodsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet7.GoodsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Description, string Original_Type, string Original_Price, string Original_Manufacturer, string Original_Supplier) {
        ...
        public virtual int Insert(string Name, string Description, string Type, string Price, string Manufacturer, string Supplier) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Description, string Type, string Price, string Manufacturer, string Supplier, int Original_Id, string Original_Name, string Original_Description, string Original_Type, string Original_Price, string Original_Manufacturer, string Original_Supplier, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, string Type, string Price, string Manufacturer, string Supplier, int Original_Id, string Original_Name, string Original_Description, string Original_Type, string Original_Price, string Original_Manufacturer, string Original_Supplier) {
            return this.Update(Name, Description, Type, Price, Manufacturer, Supplier, Original_Id, Original_Name, Original_Description, Original_Type, Original_Price, Original_Manufacturer, Original_Supplier, Original_Id);
        }
    }
