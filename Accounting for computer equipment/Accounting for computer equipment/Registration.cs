...
namespace Accounting_for_computer_equipment
{
    public partial class Registration : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\maksi\OneDrive\Desktop\Accounting for computer equipment\Accounting for computer equipment\Database.mdf;Integrated Security=True");
