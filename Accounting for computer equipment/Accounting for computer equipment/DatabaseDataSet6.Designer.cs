...
namespace Accounting_for_computer_equipment {
    ...
    public partial class DatabaseDataSet6 : global::System.Data.DataSet {
        ...
        public partial class ShoppingCartDataTable : global::System.Data.TypedTableBase<ShoppingCartRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ShoppingCartRow AddShoppingCartRow(string Name, string Description, string Type, string Quantity, string Price, string Manufacturer, string Supplier) {
        ...
        public partial class ShoppingCartRow : global::System.Data.DataRow {
            ...
            public string Type {
                get {
                    return ((string)(this[this.tableShoppingCart.TypeColumn]));
                }
                set {
                    this[this.tableShoppingCart.TypeColumn] = value;
                }
            }
            ...
            public string Quantity {
                get {
                    return ((string)(this[this.tableShoppingCart.QuantityColumn]));
                }
                set {
            ...
            public string Price {
                get {
                    return ((string)(this[this.tableShoppingCart.PriceColumn]));
                }
                set {
            ...
            public string Manufacturer {
                get {
                    return ((string)(this[this.tableShoppingCart.ManufacturerColumn]));
                }
                set {
                    this[this.tableShoppingCart.ManufacturerColumn] = value;
                }
            }
            ...
            public string Supplier {
                get {
                    return ((string)(this[this.tableShoppingCart.SupplierColumn]));
                }
                set {
                    this[this.tableShoppingCart.SupplierColumn] = value;
                }
            }
        }
...
namespace Accounting_for_computer_equipment.DatabaseDataSet6TableAdapters {
    ...
    public partial class ShoppingCartTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[ShoppingCart] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Description] = @Original_Description) AND ([Type] = @Original_Type) AND ([Quantity] = @Original_Quantity) AND ([Price] = @Original_Price) AND ([Manufacturer] = @Original_Manufacturer) AND ([Supplier] = @Original_Supplier))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[ShoppingCart] ([Name], [Description], [Type], [Quantity], [Price], [Manufacturer], [Supplier]) VALUES (@Name, @Description, @Type, @Quantity, @Price, @Manufacturer, @Supplier);
SELECT Id, Name, Description, Type, Quantity, Price, Manufacturer, Supplier FROM ShoppingCart WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ShoppingCart] SET [Name] = @Name, [Description] = @Description, [Type] = @Type, [Quantity] = @Quantity, [Price] = @Price, [Manufacturer] = @Manufacturer, [Supplier] = @Supplier WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Description] = @Original_Description) AND ([Type] = @Original_Type) AND ([Quantity] = @Original_Quantity) AND ([Price] = @Original_Price) AND ([Manufacturer] = @Original_Manufacturer) AND ([Supplier] = @Original_Supplier));
SELECT Id, Name, Description, Type, Quantity, Price, Manufacturer, Supplier FROM ShoppingCart WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Description, Type, Quantity, Price, Manufacturer, Supplier FROM " +
                "dbo.ShoppingCart";
        ...
        public virtual int Fill(DatabaseDataSet6.ShoppingCartDataTable dataTable) {
        ...
        public virtual DatabaseDataSet6.ShoppingCartDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet6.ShoppingCartDataTable dataTable = new DatabaseDataSet6.ShoppingCartDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet6.ShoppingCartDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Description, string Original_Type, string Original_Quantity, string Original_Price, string Original_Manufacturer, string Original_Supplier) {
        ...
        public virtual int Insert(string Name, string Description, string Type, string Quantity, string Price, string Manufacturer, string Supplier) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, string Type, string Quantity, string Price, string Manufacturer, string Supplier, int Original_Id, string Original_Name, string Original_Description, string Original_Type, string Original_Quantity, string Original_Price, string Original_Manufacturer, string Original_Supplier) {
            return this.Update(Name, Description, Type, Quantity, Price, Manufacturer, Supplier, Original_Id, Original_Name, Original_Description, Original_Type, Original_Quantity, Original_Price, Original_Manufacturer, Original_Supplier, Original_Id);
        }
    }
